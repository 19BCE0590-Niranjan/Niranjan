...
export function CustomerCard({ 
  ...
  return (
    <div className="relative bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl overflow-hidden transition-all duration-300 transform hover:-translate-y-1 p-6">
      
      {/* Icons positioned vertically at the top-right */}
      <div className="absolute right-3 top-3 flex flex-col space-y-2">
        <button
          onClick={() => onAddOrder(customer)}
          className="p-2 text-green-600 dark:text-green-400 hover:bg-green-50 dark:hover:bg-green-900/50 rounded-lg transition-colors"
          title="Add Order"
        >
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="flex-1 min-w-0">
          <h3 className="text-xl font-bold text-gray-900 dark:text-white whitespace-nowrap overflow-visible">
            {customer.name}
          </h3>
          <a
